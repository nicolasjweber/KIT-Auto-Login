...
- Activate the Userscripts Safari extension in the iOS Settings app
...
## Prerequisites
This extension clicks the buttons, but it **does not store your passwords, passkeys or cookies**. For fully automatic login, ensure your password manager or browser is configured to autofill your KIT username and password.
...
- Shibboleth Identity Provider (idp.scc.kit.edu)
